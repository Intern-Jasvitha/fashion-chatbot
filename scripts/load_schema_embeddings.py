#!/usr/bin/env python3
"""
Production-grade schema embedding loader for SQL agent RAG.
Generates rich semantic chunks from database schema (table definitions,
relationship patterns, security rules, query patterns) and stores them
in Qdrant collection "sql-agent" for retrieval-augmented SQL planning.
"""
...
# -----------------------------------------------------------------------------
# Embedding client (same contract as load_pdf_rag.py)
# -----------------------------------------------------------------------------
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Load schema RAG embeddings into Qdrant (collection: sql-agent)")
